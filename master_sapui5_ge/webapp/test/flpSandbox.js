		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Sapui5 German Emaldi",
									"targetURL": "#emaldicommastersapui5ge-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"emaldicommastersapui5ge-display": {
								"semanticObject": "emaldicommastersapui5ge",
								"action": "display",
								"description": "Master Sapui5 German Emaldi",
								"title": "Master Sapui5 German Emaldi",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=emaldi.com.mastersapui5ge",
									"url": sap.ui.require.toUrl("emaldi/com/mastersapui5ge")
								}
							}
						}
					}
